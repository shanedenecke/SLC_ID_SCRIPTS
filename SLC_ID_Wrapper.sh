...
./SLC_id_scripts/SLC_Create_HMM_DB.sh ~/Documents/SLC_id/general_reference/model_proteomes/DroMel_unigene.faa ~/Documents/SLC_id/Drosophila_Database/SLC_dict_flybaseXref.csv ~/Documents/SLC_id/Drosophila_Database/Post_Flybase_Xref_database

# Iteratative search Drosophila proteome problem*************************
./SLC_id_scripts/SLC_HMM_Search.sh ~/Documents/SLC_id/Drosophila_Database/Post_Flybase_Xref_database ~/Documents/SLC_id/general_reference/model_proteomes/DroMel_unigene.faa ~/Documents/SLC_id/Drosophila_Database/Dm_Final_Iterative

## Make final Drosophila database
./SLC_id_scripts/SLC_Create_HMM_DB.sh ~/Documents/SLC_id/general_reference/model_proteomes/DroMel_unigene.faa ~/Documents/SLC_id/Drosophila_Database/Dm_Final_Iterative/SLC_dict.csv ~/Documents/SLC_id/Dm_Final_Database
