...
key=fread('/data2/shane/Documents/SLC_id/general_reference/SLC_info/Dm_master_key_FB_fasta.csv')
flybase.slc=fread('/data2/shane/Documents/SLC_id/general_reference/SLC_info/DroMel_SLC_table_flybase.csv',select=c('FBgn','Family','ANNOTATION_SYMBOL')) %>% unite(col='name',Family,ANNOTATION_SYMBOL,sep='_')
